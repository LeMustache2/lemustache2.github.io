...
document.getElementById("readSurahbttn").href = "/surah.html?"+response.chapter.name_simple+"?"+(surahIndex+1)
document.getElementById("surahTitleEngTranslation").innerHTML = response["chapter"]["translated_name"]["name"];
